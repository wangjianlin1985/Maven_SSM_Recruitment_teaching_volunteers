            ...
            <div class="row row-lg">
                <form class="layui-form col-sm-8" action="" id="saveS" enctype="multipart/form-data">
                    ...
                    <div class="layui-form-item" v-if="flag">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="schoolName" lay-verify="required" required autocomplete="off" placeholder="学校名称" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea name="schoolJs" style="height: 200px" required autocomplete="off" placeholder="简介" class="layui-input"></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
