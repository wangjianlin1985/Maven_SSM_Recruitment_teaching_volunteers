                ...
                <form class="layui-form col-sm-8" action="" id="saveS" enctype="multipart/form-data">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="lxr" value="${bean.lxr}" lay-verify="required"  autocomplete="off" placeholder="真实姓名" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <!-- form-label-must 红色标注必须的class -->
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="lxfs" value="${bean.lxfs}" lay-verify="required|phone" required autocomplete="off" placeholder="联系电话" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <select name="typeId" lay-verify="required">
                                <c:forEach items="${types}" var="row">
                                    <option value="${row.id}" <c:if test="${bean.typeId == row.id}">selected</c:if>>${row.name}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="rs"value="${bean.rs}"  lay-verify="required|number" required autocomplete="off" placeholder="人数" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <!-- form-label-must 红色标注必须的class -->
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="time" id="date"  value="<fmt:formatDate value="${bean.zjTime}" type="date" pattern="yyyy-MM-dd"/> - <fmt:formatDate value="${bean.fwTime}" type="date" pattern="yyyy-MM-dd"/>" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <!-- form-label-must 红色标注必须的class -->
                        ...
                        <div class="layui-input-block">
                            <textarea name="bz" style="height: 200px"  autocomplete="off" placeholder="简介" class="layui-input">${bean.bz}</textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
...
<script>
    ...
    $(function () {
        if ('${flag}' == true){
            top.location.href = '${ctx}/web/login.do'
        }
        layui.use(['form', 'layedit', 'laydate'], function () {
            ...
            form.on('submit(saveSub)', function(data){
                ...
                $.ajax({
                    cache : true,
                    type : "post",
                    url : "${ctx}/web/yfbEditUpdate.json",
                    data : data.field,
                    async : false,
