...
<head>
    ...
    <!-- Morris -->
    <link href="${ctx}/resource/libs/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">
    <!-- Gritter -->
    <link href="${ctx}/resource/libs/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
...
<div class="wrapper wrapper-content">
    <div class="row">
        <div class="col-sm-3">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <span class="label label-success pull-right">2019年</span>
                    <h5>注册学校数</h5>
                </div>
                <div class="ibox-content">
                    <h1 class="no-margins">${xx}</h1>
        ...
        <div class="col-sm-3">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <span class="label label-info pull-right">2019年</span>
                    <h5>志愿者数量</h5>
                </div>
                <div class="ibox-content">
                    <h1 class="no-margins">${ls}</h1>
        ...
        <div class="col-sm-3">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <span class="label label-primary pull-right">2019年</span>
                    <h5>管理员数量</h5>
                </div>
                <div class="ibox-content">
                    <h1 class="no-margins">${gly}</h1>
        ...
        <div class="col-sm-3">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <span class="label label-danger pull-right">2019年</span>
                    <h5>发布职位数量</h5>
                </div>
                <div class="ibox-content">
                    <h1 class="no-margins">${zw}</h1>
...
<!-- Flot -->
<script src="${ctx}/resource/libs/js/plugins/flot/jquery.flot.js"></script>
<script src="${ctx}/resource/libs/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
<script src="${ctx}/resource/libs/js/plugins/flot/jquery.flot.spline.js"></script>
<script src="${ctx}/resource/libs/js/plugins/flot/jquery.flot.resize.js"></script>
<script src="${ctx}/resource/libs/js/plugins/flot/jquery.flot.pie.js"></script>
<script src="${ctx}/resource/libs/js/plugins/flot/jquery.flot.symbol.js"></script>
<!-- Peity -->
<script src="${ctx}/resource/libs/js/plugins/peity/jquery.peity.min.js"></script>
<script src="${ctx}/resource/libs/js/demo/peity-demo.js"></script>
<!-- 自定义js -->
<script src="${ctx}/resource/libs/js/content.js?v=1.0.0"></script>
<!-- jQuery UI -->
<script src="${ctx}/resource/libs/js/plugins/jquery-ui/jquery-ui.min.js"></script>
<!-- Jvectormap -->
<script src="${ctx}/resource/libs/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="${ctx}/resource/libs/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- EayPIE -->
<script src="${ctx}/resource/libs/js/plugins/easypiechart/jquery.easypiechart.js"></script>
<!-- Sparkline -->
<script src="${ctx}/resource/libs/js/plugins/sparkline/jquery.sparkline.min.js"></script>
<!-- Sparkline demo data  -->
<script src="${ctx}/resource/libs/js/demo/sparkline-demo.js"></script>
<script>
