            ...
            <div class="row row-lg">
                <div class="col-sm-12">
                    ...
                    <table class ="table table-bordered" >
                        <thead>
                        <tr>
                            <th data-field="id" data-sortable="true">留言人</th>
                            <th data-field="id" data-sortable="true">标题</th>
                            <th data-field="id" data-sortable="true">留言时间</th>
                            <th data-field="id" data-sortable="true">留言内容</th>
...
<script>
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            initialize: function () {
                var _that = this;
                this.$http.post('${ctx}/message/listAll.json', {userId:_that.userId, pageIndex: _that.pageIndex},{emulateJSON: true,cache:false,async:false}).then(function (res) {
            ...
            getListUsers: function () {
                ...
                var op2 = '">'
                var op3 = '</option>'
                this.$http.post('${ctx}/message/userlist.json',{emulateJSON: true,cache:false,async:false}).then(function (res) {
