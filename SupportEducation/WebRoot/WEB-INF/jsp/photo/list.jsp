            ...
            <div class="row row-lg">
                <div class="col-sm-12">
                    ...
                    <table class ="table table-bordered">
                        <thead>
                        <tr>
                            <th data-field="id" data-sortable="true">图片地址</th>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <div id="dropAreaAdd" style="width: 150px; height: 150px; border: 1px solid rgb(210, 210, 210); cursor: pointer;">
                                <div id="preview">
                                    <img :src="getImgUrl(bean.address)" class="img-responsive photo" style="width: 150px;height: 150px;" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    var app = new Vue({
        ...
        methods: {
          ...
          //获取图片地址
            ...
            initialize: function () {
                var _that = this;
                this.$http.post('${ctx}/photo/listAll.json', {pageIndex: _that.pageIndex},{emulateJSON: true,cache:false,async:false}).then(function (res) {
            ...
            getEntity: function (id) {
                var _that = this;
                this.$http.post('${ctx}/photo/edit.do', {id:id},{emulateJSON: true,cache:false,async:false}).then(function (res) {
                    _that.bean = res.data.bean;
                    $('#divNodeAdd').hide();
                    $('#divNodeEdit').show();
                    $('html,body').animate({scrollTop: $('#divNodeEdit').offset().top}, 500);
                    $(".img-responsive")[2].remove()
                    }, function () {
                });
            }
        }
            ...
            $.ajax({
                ...
                success : function(data) {
                    if (!data.flag) {
                        ...
                        // $('#divNodeAdd').hide();
                        // app.initialize()
                        window.location.href = "${ctx}/photo/list.do"
                    }
                }
            });
        });
