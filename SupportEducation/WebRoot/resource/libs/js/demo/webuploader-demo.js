(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            dnd: '#dndArea',
            paste: '#uploader',
            swf: '../libs/js/plugins/webuploader/Uploader.swf',
            chunked: true,
            chunkSize: 512 * 1024,
            server: 'http://localhost:8080/activityRecommend/upload.json',
            method:'POST',
            // runtimeOrder: 'flash',
            accept: {
                title: 'Images',
            ...
            if ( file.getStatus() === 'invalid' ) {
                ...
                uploader.makeThumb( file, function( error, src ) {
                    ...
                    if( isSupportBase64 ) {
                        ...
                        $.ajax('../clothing/upLoadPhoto.json', {
                            method: 'POST',
                            data: src,
                            dataType:'json'
            ...
            if ( state === 'ready' ) {
                ...
                if ( stats.uploadFailNum ) {
                    text = '已成功上传' + stats.successNum+ '文件，'+
                        stats.uploadFailNum + '文件上传失败，<a class="retry" href="javascript:;">重新上传</a>失败或<a class="ignore" href="javascript:;">忽略</a>'
                }
        ...
        uploader.onError = function( code ) {
            // alert( 'Eroor: ' + code );
            layer.alert('Eroor: ' + code, {icon: 6},function (index) {
                layer.close(index);
            });
        };
